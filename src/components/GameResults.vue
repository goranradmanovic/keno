  ...
  .container
    .row
      .col-md-12.col-sm-12.mt-5.mb-5.text-center
        h2.results__info--title Rezultati poslednjeg izvlačenja
    ...
    .row
      .col-md-12.col-sm-12
        router-link(:to="{ name: 'allresults', params: {} }" class='results__screen--allresults' id='allResults') Svi rezultati
</template>
